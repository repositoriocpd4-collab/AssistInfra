...
async def admin_create_school(request: Request):
    ...
    # Tenta extrair coordenadas: primeiro do payload direto, depois do maps_link, depois usa padrão
    lat, lon = None, None
    try:
...
async def admin_update_school(request: Request, school_id: int):
    ...
    # Tenta extrair coordenadas: primeiro do payload direto, depois do maps_link, depois usa valor anterior
    lat, lon = None, None
    try:
